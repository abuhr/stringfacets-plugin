...
final class LocalizedStringReader extends BasePeekableReader<CustomAttributeValue, CustomAttributeMapEntry> {

    @Inject
    public LocalizedStringReader(AttributeValidator validator, DataSourceLookup dataSourceLookup) {
    ...
    static final class Reader extends JdbcCursorItemReader4EPJ<CustomAttributeMapEntry> {
        ...
        public static final String SQL = new StringBuilder()
            ...
            .append(" JOIN localizedstringattribute pa ON pa.objectid = p.productid ")
            .append(" JOIN attribute a ON pa.attributeid = a.attributeid AND type = 'LocalizedString' AND a.isuserdefined = 1 ")
